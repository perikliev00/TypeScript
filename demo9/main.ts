...
console.log(assign1);
const assignGrade: Assigment=updateAssigment(assign1,{grade:95})
const recordAssigment=(assign: Required<Assigment>):Assigment {
    return assign
}
const assignVerified:Readonly<Assigment>={...assignGrade,verified:true}
recordAssigment({...assignGrade,verified:true});
